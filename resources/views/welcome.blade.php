...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <divf class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">
                                <span  style="color:white">Register</span></a>
                        @endif
                    @endauth
                </div>
            @endif
                    ...
                    <div class="grid grid-cols-1">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><!--a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">Documentation</a-->
                                DOCUMENTACION:
                                </div>
                            </div>
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Compartir contenido de documentacion aca
                                </div>
                            </div>
                        </div>
