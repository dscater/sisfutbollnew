                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                {{ Form::label('estado') }}
                                {!! Form::select('estado',['0' => 'Pendiente', '1' => 'Terminado'],$partido->estado, array('class' => 'form-control')) !!}
                            </div>
                            <div class="form-group">
                                {{ Form::label('tipo') }}
                                {!! Form::select('tipo', ['1' => 'clasificatoria','0' => 'Final', '2'=>'semifinal', '3'=>'cuartos'], $partido->tipo, array('class' => 'form-control')) !!}
                            </div>
