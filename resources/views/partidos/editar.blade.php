                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(['route' => ['partidos.update', $id], 'method' => 'PATCH']) !!}
                            <div class="box-body">
                                <div class="form-group">
                                    {{ Form::label('campeonato_id') }}
                                    {!! Form::select('campeonato_id', $campeonato, $partido->campeonato_id, ['class' => 'form-control']) !!}
                                </div>
                                <div class="form-group">
                                    {{ Form::label('Equipo A') }}
                                    {!! Form::select('equipoA_id', $equipo, $partido->equipoA_id, ['class' => 'form-control']) !!}
                                </div>
                                <h3>VS</h3>
                                <div class="form-group">
                                    {{ Form::label('Equipo B') }}
                                    {!! Form::select('equipoB_id', $equipo, $partido->equipoB_id, ['class' => 'form-control']) !!}
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::date('fecha_Par', $partido->fecha_Par && $partido->fecha_Par != null ? $partido->fecha_Par : date('Y-m-d'), ['class' => 'form-control' . ($errors->has('fecha_par') ? ' is-invalid' : ''), 'placeholder' => 'Fecha Inicio']) }}
                                ...
                                <div class="form-group">
                                    {{ Form::label('estado') }}
                                    {!! Form::select('estado', ['0' => 'Pendiente', '1' => 'Terminado'], $partido->estado, [
                                        'class' => 'form-control',
                                    ]) !!}
                                </div>
                                <div class="form-group">
                                    ...
                                    {!! Form::select(
                                        ...
                                        [
                                            '1' => 'clasificatoria',
                                            '4' => 'clasificatoria segunda ronda',
                                            '0' => 'Final',
                                            '2' => 'semifinal',
                                            '3' => 'cuartos',
                                        ],
