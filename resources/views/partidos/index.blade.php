                        ...
                        <div class="card-header">
                            ...
                            <table class="table table-striped mt-1">
                                <thead style="background-color:#6777ef">
                                    ...
                                    <th style="color:#fff;">Equipo_A</th>
                                    <th style="color:#fff;">Goles A</th>
                                    <th style="color:#fff;">Equipo_B</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($partidos as $partido )
                                        <tr>
                                            ...
                                            <td>
                                                @if ($partido->estado  == "1")
                                                <a class="btn btn-success" href="{{ route('puntos.create', $partido->id) }}">Actualizar puntos</a>
                                                @else
                                                @endif
                                                <a class="btn btn-primary" href="{{ route('partidos.edit', $partido->id) }}">Ver y/o Editar</a>
                                                {!! Form::open(['method' => 'DELETE','route' => ['partidos.destroy', $partido->id],'style'=>'display:inline']) !!}
